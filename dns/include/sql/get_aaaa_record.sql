...
WITH name_record AS (
    SELECT
        dns_aaaa_record.searchname as name,
        dns_aaaa_record.searchdomain as domainname,
        dns_aaaa_record.ttl as ttl,
        dns_cname_record.canonical_name as cname,
        dns_aaaa_record.domain_id as domain_id,
    ...
    LEFT OUTER JOIN
        dns_cname_record
    ON
        dns_aaaa_record.host_id=dns_cname_record.host_id AND
